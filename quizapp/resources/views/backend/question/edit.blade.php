	...
	<div class="module">
            ...
            <div class="controls">
                ...
                <br>
                    ...
                    <img src="{{asset('question_images')}}/{{$question->background}}" width="100px" alt="">
                    @endif
                    <br>
			 ...
			 <div class="control-group">
				...
				<div class="controls"> 
                    ...
                    <img src="{{asset('question_images')}}/{{$answer->background}}" width="100px" alt="">
                    @endif
                    <br>
                    <input type="file" name="options-img[]" class="span8" value="{{$answer->background}}"><br>
